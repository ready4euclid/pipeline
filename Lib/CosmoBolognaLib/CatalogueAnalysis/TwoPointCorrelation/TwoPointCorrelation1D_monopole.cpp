...
void cosmobl::twopt::TwoPointCorrelation1D_monopole::measure (const string dir_output_pairs, const vector<string> dir_input_pairs, const ErrorType errorType, const string dir_output_ResampleXi, int nMocks, int count_dd, const int count_rr, const int count_dr, const bool tcount)
{
  switch(errorType){
