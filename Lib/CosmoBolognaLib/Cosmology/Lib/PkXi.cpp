...
void cosmobl::Cosmology::Pk_Kaiser_multipoles (vector<double> &Pk0, vector<double> &Pk2, vector<double> &Pk4, const vector<double> kk, const string method_Pk, const bool NL, const double redshift, const double bias, const string output_root, const int norm, const double k_min, const double k_max, const bool GSL, const double prec, const string file_par)
{ 
  ...
  vector<vector<double> > Pk_multipoles = cosmobl::Pk_multipole_Kaiser({0,2,4}, kk, Pk_arr, bias, f);
  Pk0 = Pk_multipoles[0];
  Pk2 = Pk_multipoles[2];
  Pk4 = Pk_multipoles[4];
