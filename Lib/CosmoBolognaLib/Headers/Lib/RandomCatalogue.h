...
namespace cosmobl {
   ...
   */
  shared_ptr<catalogue::Catalogue> random_catalogue_fromFile (const vector<string> file, const double nSub=1.1); 
   ...
   *  @return an object of class Catalogue
   */
  shared_ptr<catalogue::Catalogue> random_catalogue_radecred_fromFile (const string file_in, const double z_min, const double z_max, const Cosmology &cosm, const double nSub=1.1, const double fact=1.); 
  
  /**
   *  @brief create a random catalogue in a box
   *  @param catalogue object of class Catalogue
   *  @param nRandom number of random objects
   *  @return a pointer to an object of class Catalogue
   */
  shared_ptr<catalogue::Catalogue> random_catalogue_box (const shared_ptr<catalogue::Catalogue> catalogue, const int nRandom);
   ...
   *  @return an object of class Catalogue
   */
  shared_ptr<catalogue::Catalogue> warped_random_catalogue (const Cosmology &real_cosm, const Cosmology &test_cosm, const string dir_in, const string dir_out, const double Zguess_min, const double Zguess_max);
   ...
   *  @return an object of class Catalogue
   */
  shared_ptr<catalogue::Catalogue> random_catalogue_cone (const shared_ptr<catalogue::Catalogue> catalogue, const int nRandom, const Cosmology &cosm, const double Angle, const int step_redshift, const vector<double> redshift, vector<double> &dc, vector<double> &convol, const int idum=13);
   ...
   *  @return an object of class Catalogue
   */
  shared_ptr<catalogue::Catalogue> random_catalogue_mock (const shared_ptr<catalogue::Catalogue> catalogue, const int nRandom, const Cosmology &cosm, const string dir, const int step_redshift, const vector<double> redshift, vector<double> &dc, vector<double> &convol, int idum=13);
   ...
   *  @return none
   */
  void random_redshift_distribution (const shared_ptr<catalogue::Catalogue> random, const shared_ptr<catalogue::Catalogue> data, const string dir_random, const int nbin, const bool convolution, const double sigma);

  /// @cond extrandom
  shared_ptr<catalogue::Catalogue> random_catalogue_mock_cone (const shared_ptr<catalogue::Catalogue>, const int, const Cosmology &, const string, const int, vector<double>);

  shared_ptr<catalogue::Catalogue> random_catalogue_VIPERS (const int, const Cosmology &, const string, const int, const vector<double>, const vector<double>, const vector<double>, const vector<double>, const bool, string, const string, const string, const int idum=13); 

  shared_ptr<catalogue::Catalogue> random_sdss_angular_distribution (const int, const string, const string, const bool veto=0); 
  /// @endcond
