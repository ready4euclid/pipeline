...
namespace cosmobl {
  ...
  namespace twopt {
	...
	{ m_twoPType = _1D_projected_; }
       ...
       *  @return none
       */
      void measure (const double piMax_integral=50., const string dir_output_pairs="NULL", const vector<string> dir_input_pairs={}, const int count_dd=1, const int count_rr=1, const int count_dr=1, const bool tcount=1) override;
