...
void cosmobl::Data2D::write (const string dir, const string file, const string xname, const string yname, const string fxyname, const int rank) const 
{
